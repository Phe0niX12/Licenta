...
class AuthService {
  ...
  Future<bool> signIn(String email, String password) async {
    final url = Uri.parse('http://10.0.2.2:3000/sign_in'); // Use 10.0.2.2 for Android emulator
  ...
  Future<bool> signUp(String username, String email, String password) async {
    final url = Uri.parse('http://10.0.2.2:3000/sign_up'); // Use 10.0.2.2 for Android emulator
  ...
  Future<http.Response> authenticatedRequest(String endpoint) async {
    ...
    final url = Uri.parse('http://10.0.2.2:3000/$endpoint'); // Adjust the base URL accordingly
